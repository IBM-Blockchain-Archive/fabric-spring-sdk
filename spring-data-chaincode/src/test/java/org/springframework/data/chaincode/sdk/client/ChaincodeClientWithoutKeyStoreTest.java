...
@ContextConfiguration(classes = {TestConfigWithoutKeyStore.class})
public class ChaincodeClientWithoutKeyStoreTest {
	...
	public void testClient() {
		...
		System.out.println("(" + prevAString + ", " + prevBString + ") => (" + newAString + ", " + newBString + ")");
